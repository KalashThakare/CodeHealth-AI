...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[var(--color-bg)]">
      ...
      <section className="features-section py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[var(--color-fg)] mb-4">
              Why Choose CodeHealth AI?
            </h2>
            <p className="text-xl text-[var(--color-fg-secondary)] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature-card card text-center">
              <div className="neon-element w-16 h-16 bg-[var(--color-primary)] rounded-full mx-auto mb-6 flex items-center justify-center">
                <span className="text-2xl">🧠</span>
              </div>
              <h3 className="text-xl font-semibold text-[var(--color-fg)] mb-4">
                AI-Powered Analysis
              </h3>
            ...
            <div className="feature-card card text-center">
              <div className="neon-element w-16 h-16 bg-[var(--color-accent)] rounded-full mx-auto mb-6 flex items-center justify-center">
                <span className="text-2xl">⚡</span>
              </div>
              <h3 className="text-xl font-semibold text-[var(--color-fg)] mb-4">
      ...
      {/* Stats Section */}
      <section className="stats-section py-16 bg-[var(--color-bg-secondary)]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-[var(--color-primary)] mb-2">
                <span className="stat-number" data-value="10000">
                  0
                </span>
                +
              </div>
            ...
            <div>
              <div className="text-4xl font-bold text-[var(--color-primary)] mb-2">
                <span className="stat-number" data-value="50000">
                  0
                </span>
                +
              </div>
            ...
            <div>
              ...
              <p className="text-[var(--color-fg-secondary)]">Accuracy Rate</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-[var(--color-primary)] mb-2">
              ...
              <p className="text-[var(--color-fg-secondary)]">Uptime</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-[var(--color-fg)] mb-6">
            Ready to Transform Your Code Quality?
          </h2>
          <p className="text-xl text-[var(--color-fg-secondary)] mb-8 max-w-2xl mx-auto">
