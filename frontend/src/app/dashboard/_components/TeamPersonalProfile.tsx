...
// const TeamPersonalProfile: React.FC = () => {
...
//       <div
//         className="absolute top-full left-0 mt-2 rounded-2xl border z-50 overflow-hidden"
//         style={{
...
//           {/* Left Panel - Teams */}
          // <div
          //   className="w-fit border-r flex flex-col"
          ...
          //         <div
          //           key={team.id}
          //           className="flex items-center w-fit p-3 rounded-md transition-colors duration-200 cursor-pointer"
          //           style={{
...
// import React, { useState, useRef, useEffect } from "react";
// import { Search, Plus, Check, Github, Star, GitFork } from "lucide-react";
...
//   // Mock teams data - replace with your actual data
//   const teams: Team[] = [
//     {
//       id: "1",
//       name: "Jayesh Rajbhar's projects",
...
//     <div className="relative" ref={dropdownRef}>
//       <div
//         className="absolute top-full h-fit w-fit left-0 mt-2 rounded-2xl border z-50 overflow-hidden"
//         style={{
//           backgroundColor: "var(--color-card)",
//           borderColor: "var(--color-border)",
//           boxShadow: "var(--shadow)",
...
//           {/* Left Panel - Teams */}
//           <div
//             className="col-span-1 border-r flex flex-col"
//             style={{ borderColor: "var(--color-border)" }}
//           >
//             {/* Search Teams */}
//             <div
...
//                     <div
//                       key={repo.id}
//                       className="flex items-center justify-between p-2 rounded-md transition-colors duration-200 cursor-pointer border"
//                       style={{
//                         backgroundColor:
